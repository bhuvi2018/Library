...
function createGenreAuthors(cb) {
    async.parallel([
        function(callback) {
          authorCreate('Karthick', 'Rosy', '1973-06-06', false, callback);
        },
        function(callback) {
          authorCreate('Ben', 'Bhavana', '1932-11-8', false, callback);
        },
        function(callback) {
          authorCreate('Isaac', 'Santhosh', '1920-01-02', '1992-04-06', callback);
        },
        function(callback) {
